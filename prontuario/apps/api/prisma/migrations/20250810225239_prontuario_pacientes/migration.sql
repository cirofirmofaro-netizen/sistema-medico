...
-- AddForeignKey
ALTER TABLE "public"."PagamentoPlantao" ADD CONSTRAINT "PagamentoPlantao_plantaoId_fkey" FOREIGN KEY ("plantaoId") REFERENCES "public"."Plantao"("id") ON DELETE CASCADE ON UPDATE CASCADE;
