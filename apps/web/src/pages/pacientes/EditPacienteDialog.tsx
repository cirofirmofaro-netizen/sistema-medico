...
import { Paciente, UpdatePacienteData } from '../../types'
...
export function EditPacienteDialog({ open, paciente, onClose, onSuccess }: EditPacienteDialogProps) {
  ...
  // Reset form when paciente changes
  useEffect(() => {
    if (paciente) {
      reset({
        nome: paciente.nome,
        dtNasc: paciente.dtNasc || undefined,
        sexo: (paciente.sexo as 'M' | 'F') || undefined,
  ...
  const updateMutation = useMutation({
    mutationFn: pacientesService.updatePaciente,
    onSuccess: () => {
